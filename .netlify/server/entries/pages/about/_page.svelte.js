...
const AboutButton = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<div class="${'heroBtns svelte-2ls6ks'}"><a${add_attribute(
		'href',
		links,
		0
	)} class="${'svelte-2ls6ks'}"><button class="${'svelte-2ls6ks'}">${escape(title)}</button></a>
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	$$result.css.add(css);
	return `<main class="${'svelte-1jnqem7'}">${validate_component(
		AboutCircle,
		'AboutCircle'
	).$$render($$result, {}, {}, {})}
	<div class="${'aboutText svelte-1jnqem7'}">${validate_component(AboutText, 'AboutText').$$render(
		$$result,
		{},
		{},
		{}
