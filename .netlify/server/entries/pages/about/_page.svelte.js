...
const AboutButton = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"heroBtns svelte-riqase"}"><a${add_attribute("href", links, 0)} class="${"svelte-riqase"}"><button class="${"svelte-riqase"}">${escape(title)}</button></a>
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<main class="${"svelte-14kzcdo"}">${validate_component(AboutCircle, "AboutCircle").$$render($$result, {}, {}, {})}
    <div class="${"aboutText svelte-14kzcdo"}">${validate_component(AboutText, "AboutText").$$render($$result, {}, {}, {})}
