...
const ProjectCard = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"projects svelte-brc302"}"><button class="${"svelte-brc302"}"><img${add_attribute("src", projectImg, 0)} alt="${"Insparition for project"}" class="${"svelte-brc302"}"></button></div>
${!visible ? `<main class="${"svelte-brc302"}"><button class="${"svelte-brc302"}"><i class="${"fas fa-x"}"></i></button>
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<main class="${"svelte-p70m5k"}"><h1 class="${"svelte-p70m5k"}">Selected Projects</h1>
	<div class="${"SelectedProjects svelte-p70m5k"}"><div class="${"project-1 svelte-p70m5k"}">${validate_component(ProjectCard, "ProjectCard").$$render(
    $$result,
    {
