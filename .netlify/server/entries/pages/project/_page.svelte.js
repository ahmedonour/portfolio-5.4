...
const ProjectCard = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `
<div class="${"projcets"}"><div class="${"projects-list svelte-bksgpj"}"><ol class="${"svelte-bksgpj"}"><li class="${"svelte-bksgpj"}">${escape(projectTitle)}</li></ol></div>
</div>`;
});
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<main class="${"svelte-qphee0"}"><h1 class="${"svelte-qphee0"}">Selected Projects</h1>
	<div class="${"SelectedProjects svelte-qphee0"}">${validate_component(ProjectCard, "ProjectCard").$$render(
    $$result,
    {
