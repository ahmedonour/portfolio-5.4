...
const Herobuttons = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<div class="${'heroBtns svelte-bok6rm'}"><a${add_attribute(
		'href',
		links,
		0
	)} class="${'svelte-bok6rm'}"><button class="${'svelte-bok6rm'}">${escape(title)}</button></a>
...
const HeroText = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  <div class="${'heroButtons svelte-1lhhcnn'}">${validate_component(
		Herobuttons,
		'Herobuttons'
	).$$render(
		$$result,
    ...
    ${validate_component(Herobuttons, 'Herobuttons').$$render(
			$$result,
...
const HeroSocialIcons = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `${
		(($$result.head += `<!-- HEAD_svelte-1ttyl48_START --><script src="${'https://kit.fontawesome.com/f3c7bd6f07.js'}" crossorigin="${'anonymous'}"><\/script><!-- HEAD_svelte-1ttyl48_END -->`),
		'')
	}
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	$$result.css.add(css);
	return `<main class="${'svelte-1cxsd4r'}"><div class="${'herosection svelte-1cxsd4r'}">${validate_component(
		HeroSocialIcons,
		'HeroSocialIcons'
	).$$render($$result, {}, {}, {})}
