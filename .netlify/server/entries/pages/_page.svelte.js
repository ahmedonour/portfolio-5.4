...
const Herobuttons = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<div class="${'heroBtns svelte-lrbkjk'}"><a${add_attribute(
		'href',
		links,
		0
	)} class="${'svelte-lrbkjk'}"><button id="${'btn'}" class="${'svelte-lrbkjk'}">${escape(
		title
	)}</button></a>
...
const HeroText = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	<div class="${'heroButtons svelte-rxa54u'}">${validate_component(
		Herobuttons,
		'Herobuttons'
	).$$render(
		$$result,
...
const HeroSocialIcons = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `${
		(($$result.head += `<!-- HEAD_svelte-11z5d5n_START --><script src="${'https://kit.fontawesome.com/f3c7bd6f07.js'}" crossorigin="${'anonymous'}"><\/script><!-- HEAD_svelte-11z5d5n_END -->`),
		'')
	}
